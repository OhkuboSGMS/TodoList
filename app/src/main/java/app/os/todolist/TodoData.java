...
public class TodoData {
    ...
    public TodoData readJson(JsonReader reader)throws IOException{
        ...
        reader.beginObject();
        reader.nextName();tmp.setTitle(reader.nextString());
        reader.nextName();tmp.setMessage(reader.nextString());
        int year,month,day;
        reader.nextName();year=reader.nextInt();
        reader.nextName();month=reader.nextInt();
        reader.nextName();day=reader.nextInt();
        tmp.setDate(year,month,day);
        int hour,minute;
        reader.nextName();hour=reader.nextInt();
        reader.nextName();minute=reader.nextInt();
